...
kalah = font1.render('KAMU KALLAH!!!!',True,(255,50,10))
menang = font1.render('KAMU BERHASIL YEAY!!!',True,(50,255,10))
...
num_fire = 0
 ...
 #ships missed
#parent class for other from random import randintsprites
